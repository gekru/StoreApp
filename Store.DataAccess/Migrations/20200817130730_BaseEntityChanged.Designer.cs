...
namespace Store.DataAccess.Migrations
{
    ...
    [Migration("20200817130730_BaseEntityChanged")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole<long>", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            ConcurrencyStamp = "6a210b0a-9663-4767-baef-5cf0b8e8bf80",
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2L,
                            ConcurrencyStamp = "72237bea-50b8-4da0-bf2d-83f598e8b565",
                            Name = "Client"
                        });
                });
            ...
            modelBuilder.Entity("Store.DataAccess.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "89a1a769-55a1-4358-8768-7ee5caac7829",
                        ...
                        new
                        {
                            Id = 2L,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "16b3fc4b-b59d-4b06-b9ca-2148ca7bca05",
                            Email = "ls@mail.com",
                            EmailConfirmed = false,
                            FirstName = "Lincoln",
                            LastName = "Smith",
                        ...
                        new
                        {
                            Id = 3L,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "2f97e118-796b-42e1-af0d-af730781450c",
                            Email = "zoe@mail.com",
                            EmailConfirmed = false,
                            FirstName = "Zoe",
                            LastName = "Wilson",
            ...
            modelBuilder.Entity("Store.DataAccess.Entities.Author", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreationDate = new DateTime(2020, 8, 17, 16, 7, 30, 137, DateTimeKind.Local).AddTicks(6645),
                            IsRemoved = false,
                            Name = "Brit Bennett"
                        },
                        new
                        {
                            Id = 2L,
                            CreationDate = new DateTime(2020, 8, 17, 16, 7, 30, 140, DateTimeKind.Local).AddTicks(1830),
                            IsRemoved = false,
                            Name = "Brad Thor"
                        });
                });
            ...
            modelBuilder.Entity("Store.DataAccess.Entities.AuthorInPrintingEdition", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2020, 8, 17, 16, 7, 30, 140, DateTimeKind.Local).AddTicks(7282),
                            Id = 0L,
                            IsRemoved = false
                        });
                });
            ...
            modelBuilder.Entity("Store.DataAccess.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2020, 8, 15, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2020, 8, 12, 0, 0, 0, 0, DateTimeKind.Local),
            ...
            modelBuilder.Entity("Store.DataAccess.Entities.OrderItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 2,
                            Count = 1,
                            CreationDate = new DateTime(2020, 8, 17, 16, 7, 30, 141, DateTimeKind.Local).AddTicks(2296),
                            Currency = 1,
                            IsRemoved = false,
                            OrderId = 1L,
                            PrintingEditionId = 1L
                        ...
                        new
                        {
                            ...
                            Amount = 1,
                            Count = 1,
                            CreationDate = new DateTime(2020, 8, 17, 16, 7, 30, 141, DateTimeKind.Local).AddTicks(2352),
                            Currency = 1,
                            IsRemoved = false,
                            OrderId = 2L,
            ...
            modelBuilder.Entity("Store.DataAccess.Entities.Payment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreationDate = new DateTime(2020, 8, 17, 16, 7, 30, 141, DateTimeKind.Local).AddTicks(89),
                            IsRemoved = false,
                            TransactionId = 1L
                        },
                        new
                        {
                            Id = 2L,
                            CreationDate = new DateTime(2020, 8, 17, 16, 7, 30, 141, DateTimeKind.Local).AddTicks(131),
                            IsRemoved = false,
                            TransactionId = 2L
                        });
                });
            ...
            modelBuilder.Entity("Store.DataAccess.Entities.PrintingEdition", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreationDate = new DateTime(2020, 8, 17, 16, 7, 30, 140, DateTimeKind.Local).AddTicks(4449),
                            Currency = 1,
                        ...
                        {
                            Id = 2L,
                            CreationDate = new DateTime(2020, 8, 17, 16, 7, 30, 140, DateTimeKind.Local).AddTicks(4534),
                            Currency = 1,
